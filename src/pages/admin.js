              ...
              <td>
                ...
                <div style="display:flex; align-items:center; gap:10px; margin-top: 4px;">
                  ...
                  <a href="https://wa.me/${order.customerPhone.replace(/[\s\-\+]/g, '').replace(/^91/, '91')}?text=${encodeURIComponent(`Hello ${order.customerName}, regarding your order ${order.orderId} from Shree Shyam Restaurant...`)}" 
                     target="_blank" 
                     class="btn btn-sm" 
                     style="background:var(--clr-saffron); color:white; border:none; padding: 6px 12px; font-size: 0.8rem; display:inline-flex; align-items:center; gap:6px; border-radius:var(--radius-md); text-decoration:none; box-shadow:var(--shadow-sm); font-weight:600; margin-top:8px;">
